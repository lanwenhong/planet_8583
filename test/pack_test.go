...
func TestRefundReq(t *testing.T) {
	...
	pData := &planet_8583.ProtoStruct{
		...
		MchntId:                  "188000344333",
		CurrencyCd:               "344",
		RetrievalReferenceNumber: "530957669576",
		//Pin:          "AA17EAB7BF18034B",
	}
	pData.Domain63Tags = make(map[string][]byte)
...
func TestVoidSalesReq(t *testing.T) {
	...
	pData := &planet_8583.ProtoStruct{
		...
		MchntId:                  "188000344333",
		CurrencyCd:               "344",
		RetrievalReferenceNumber: "530957676523",
		//Pin:          "AA17EAB7BF18034B",
	}
	pData.Domain63Tags = make(map[string][]byte)
...
func TestVoidRefundReq(t *testing.T) {
	...
	pData := &planet_8583.ProtoStruct{
		...
		MchntId:                  "188000344333",
		CurrencyCd:               "344",
		RetrievalReferenceNumber: "530957676228",
		//Pin:          "AA17EAB7BF18034B",
	}
	pData.Domain63Tags = make(map[string][]byte)
